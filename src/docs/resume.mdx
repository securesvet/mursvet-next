...
- [github.com/securesvet/mursvet-next](https://github.com/securesvet/mursvet-next)
- [github.com/securesvet/murme](https://github.com/securesvet/murme)

## Опыт работы (10 месяцев)

### ШРИ Яндекс — Frontend-разработчик

**Июнь 2025 - Август 2025**

- Разработка проекта для [education.yandex.ru](https://education.yandex.ru)
- Рекомендательное письмо по [ссылке: https://mursvet.ru/recommend_yandex_27_08_2025.pdf](https://mursvet.ru/recommend_yandex_27_08_2025.pdf)
