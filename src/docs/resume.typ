...
React, Next.js, Node.js, Redux, Zustand, MobX
...
- Member of #link("https://contest.yandex.com")[Yandex.Contest] development team.
- Development of new user interface.
- Development of admin panel for the service.
- Maintained CI/CD for the project.
- Enhanced developer experience in the project.
- Adding modern tools for development.
- Research for a proper i18n integration.
- Contributing to the bussiness unit design system.

=== Yandex School — Developer
*June 2025 – August 2025*
- Developed and delivered R&D project for #link("https://education.yandex.ru")[education.yandex.ru].
...
- Configuring and creating S3 buckets.
- Maintained and developed internal documentation services.
- AI integration in documentation service.
...
For more visit #link("https://www.mursvet.ru")[mursvet.ru]
